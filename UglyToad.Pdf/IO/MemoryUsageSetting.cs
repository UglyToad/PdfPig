namespace UglyToad.Pdf.IO
{
    ...
    {
        private readonly bool useMainMemory;
         ...
         */
        private MemoryUsageSetting(bool useMainMemory, bool useTempFile,
            long maxMainMemoryBytes, long maxStorageBytes)
        {
            // do some checks; adjust values as needed to get consistent setting
            bool locUseMainMemory = useTempFile ? useMainMemory : true;
         ...
         */
        public MemoryUsageSetting setTempDir(string tempDir)
        {
