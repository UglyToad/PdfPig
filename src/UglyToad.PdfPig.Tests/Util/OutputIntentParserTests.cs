namespace UglyToad.PdfPig.Tests.Util
{
    ...
    public class OutputIntentParserTests
    {
        ...
        public void DestOutputProfileRefIsParsed()
        {
            ...
            Assert.Equal(iccVersion, intent.DestOutputProfileRef.ICCVersion);
            Assert.Equal(checkSum, intent.DestOutputProfileRef.CheckSum);
        ...
        public void AnEmptyDestOutputProfileRefLeavesEveryEntryNull()
        {
            ...
            Assert.Null(reference.ICCVersion);
            Assert.Null(reference.CheckSum);
