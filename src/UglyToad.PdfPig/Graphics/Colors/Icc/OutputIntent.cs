namespace UglyToad.PdfPig.Graphics.Colors.Icc
{
    ...
    public sealed class OutputIntent
    {
        ...
        /// <para>
        /// <see langword="null"/> when the entry is absent (incorrect).
        /// </para>
        /// </summary>
        ...
        /// <param name="preferredSubtype">An <c>/S</c> subtype to rank ahead of all others, i.e. <c>GTS_PDFX</c>, <c>GTS_PDFA1</c>,
        /// <c>ISO_PDFE1</c> or an extension key, matched exactly, as the built-in subtypes are.
        /// <para><see langword="null"/>, the default, is the built-in order.</para>
        /// </param>
        public static OutputIntent? SelectForColorManagement(IReadOnlyList<OutputIntent>? outputIntents, string? preferredSubtype = null)
        {
        ...
        /// <summary>
        /// The preference order of an output intent subtype, lower being preferred.
        /// </summary>
