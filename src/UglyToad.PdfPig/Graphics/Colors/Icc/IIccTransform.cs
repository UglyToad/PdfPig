namespace UglyToad.PdfPig.Graphics.Colors.Icc
{
    ...
    public interface IIccTransform
    {
        ...
        /// <summary>
        /// Convert a packed device-space sample buffer (8-bit per component, <see cref="NumberOfComponents"/>
        /// components per pixel) to interleaved sRGB bytes (3 bytes per pixel).
        /// </summary>
