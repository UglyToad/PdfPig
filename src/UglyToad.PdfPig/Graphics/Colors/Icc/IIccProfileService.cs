namespace UglyToad.PdfPig.Graphics.Colors.Icc
{
    ...
    public interface IIccProfileService
    {
        ...
        /// subtype to rank ahead of all others, matched exactly. Only consulted when <see cref="UseOutputIntent"/>
        /// is <see langword="true"/>.
        /// <para>
        /// <see cref="OutputIntent.PdfXSubtype"/> is the usual answer: PDF/X exists to pin down device colour.
