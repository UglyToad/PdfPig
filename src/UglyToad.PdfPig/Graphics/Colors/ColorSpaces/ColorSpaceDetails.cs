namespace UglyToad.PdfPig.Graphics.Colors
{
    ...
    public abstract class ColorSpaceDetails
    {
        ...
        /// index, and Lab and an L*a*b* ICC profile, whose L* runs to 100 - override it. PDFBox makes the
        /// equivalent method abstract on <c>PDColorSpace</c>; here it is virtual so that only the spaces
        /// that differ have to say so.
        /// </para>
        /// </summary>
        /// <param name="bitsPerComponent">Bits per component of the image the samples came from.</param>
        /// <param name="destination">
        /// Receives the decode array. Must be 2 x <see cref="NumberOfColorComponents"/> long.
        /// </param>
