namespace UglyToad.PdfPig.DocumentLayoutAnalysis.PageSegmenter
{
    ...
    public class DocstrumBoundingBoxes : IPageSegmenter
    {
        ...
        private IReadOnlyList<TextBlock> GetBlocks(IEnumerable<Word> words,
            ...
            int maxDegreeOfParallelism)
        {
            ...
            if (!GetSpacingEstimation(wordsList, wlBounds, wlBinSize, blBounds, blBinSize,
            ...
            var lines = GetLines(wordsList, maxWithinLineDistance, wlBounds, maxDegreeOfParallelism).ToArray();
        ...
        #region Blocking
        private static IEnumerable<TextBlock> GetStructuralBlocks(TextLine[] lines,
