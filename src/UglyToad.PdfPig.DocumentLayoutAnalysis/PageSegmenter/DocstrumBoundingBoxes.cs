namespace UglyToad.PdfPig.DocumentLayoutAnalysis.PageSegmenter
{
    ...
    public class DocstrumBoundingBoxes : IPageSegmenter
    {
            ...
            int maxDegreeOfParallelism)
        {
            ...
            var lines = GetLines(words, maxWithinLineDistance, wlBounds, maxDegreeOfParallelism).ToArray();

            // 3. Structural Block Determination
            double maxBetweenLineDistance = blMultiplier * betweenLineDistance;
            return GetStructuralBlocks(lines, maxBetweenLineDistance, angularDifferenceBounds, epsilon, maxDegreeOfParallelism).ToList();
        }
        ...
        /// <param name="wlBounds"></param>
        /// <param name="wlBinSize"></param>
        /// <param name="blBounds"></param>
        /// <param name="blBinSize"></param>
        ...
        #region Text Lines
        private static IEnumerable<TextLine> GetLines(IReadOnlyList<Word> words, double maxWLDistance, AngleBounds withinLine, int maxDegreeOfParallelism)
        {
            ...
            {
                yield return new TextLine(groupedIndexes[a].Select(i => words[i]).OrderByReadingOrder());
            }
        }
        ...
        private static IEnumerable<TextBlock> GetStructuralBlocks(IReadOnlyList<TextLine> lines,
            double maxBLDistance, AngleBounds angularDifference, double epsilon, int maxDegreeOfParallelism)
        {
            /******************************************************************************************************
            ...
            {
                yield return new TextBlock(groupedIndexes[a].Select(i => lines[i]).OrderByReadingOrder());
            }
        }
        ...
        /// </summary>
        public class DocstrumBoundingBoxesOptions : DlaOptions
        {
            /// <summary>
