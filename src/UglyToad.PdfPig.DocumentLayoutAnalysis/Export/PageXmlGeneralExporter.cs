namespace UglyToad.PdfPig.DocumentLayoutAnalysis.Export
{
    ...
    public class PageXmlGeneralExporter
    {
        ...
        /// <summary>
        /// Get the PAGE-XML (XML) string of the pages layout using the <see cref="IBlock"></see>'s as the page layout
        /// </summary>
        /// <param name="page">The Page</param>
        /// <param name="blocks">Blocks to be exported</param>
        /// <returns></returns>
        public string Get(Page page, IEnumerable<IBlock> blocks)
        {
        ...
        private PageXmlDocument.PageXmlPage CreatePage(double pageHeight, double pageWidth, IEnumerable<IBlock> blocks)
        {
        ...
        private PageXmlDocument.PageXmlRegion ToRegion(IBlock block, double pageWidth, double pageHeight)
        {
